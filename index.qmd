...
author: "Michael Wanek and Woodny Dorceans"
date: '`r Sys.Date()`'
format:
  html:
    code-fold: true
...
statistics. In kernel estimator, weight function is known as kernel function [@efr2008]. Cite this paper [@bro2014principal].
